...
const scenes: readonly Scene[] = [
  ...
  },
  {
    ...
    data: [
      ...
      { tone: "dim", text: "sandbox: proxmox-lxc (pool lease active)" },
      { tone: "plain", text: "" },
      { tone: "ok", text: "leasing open-agents-2 from pool" },
      { tone: "ok", text: "mounting /workspace" },
      { tone: "ok", text: "starting code-server" },
      { tone: "ok", text: "starting dev server" },
      { tone: "ok", text: "releasing node with hard reset" },
      { tone: "plain", text: "" },
      { tone: "plain", text: "sandbox run complete." },
      { tone: "dim", text: "  node: open-agents-2" },
      { tone: "dim", text: "  workspace: /workspace" },
      { tone: "ok", text: "lease returned to pool" },
    ],
  },
  {
    name: "subagent",
