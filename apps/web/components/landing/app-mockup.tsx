...
const sessions: readonly FakeSession[] = [
  {
    title: "Local cleanup",
    repo: "open-agents",
    branch: "chore/local-first-shell",
    prompt: "Remove the hosted leftovers and tighten the local shell",
    summary:
      "Trimmed the last hosted-era landing copy, removed dead auth and profile files, and patched client-side ID generation for older browsers.",
    toolCount: 15,
    todoTotal: 4,
    todoDone: 4,
    elapsed: "58s",
    files: [
      "app/settings/preferences-section.tsx",
      "components/landing/features.tsx",
      "lib/client-id.ts",
    ],
  },
  {
    title: "GitHub token flow",
    repo: "open-agents",
    branch: "feat/local-github-token",
    prompt: "Use one server token for clone, push, and pull request flows",
    summary:
      "Wired server-managed GitHub access into the repo selector, PR flow, and sandbox shell so the agent can use gh without OAuth or app installs.",
    toolCount: 11,
    todoTotal: 3,
    todoDone: 3,
    elapsed: "1m 07s",
  ...
  },
  {
    ...
    files: [
      ...
      "scripts/install-homelab-hooks.sh",
      "package.json",
    ],
  },
];
